...
var PDFViewer = function (_BaseViewer) {
  ...
  _createClass(PDFViewer, [{
    ...
    value: function update() {
     ...
     document.getElementById("pageSum").innerText = this._currentPageNumber+" / "+this.pagesCount;
    }
  }, {
...
var BaseViewer = function () {
  ...
  _createClass(BaseViewer, [{
    ...
    value: function setDocument(pdfDocument) {
      ...
      // var select = document.getElementById("scaleSelectPage");
      // var firstOption=document.createElement("option");
      // firstOption.innerHTML="1 / "+pagesCount;
      // select.appendChild(firstOption);
        var pageSum = document.getElementById("pageSum");
        pageSum.innerHTML=" 1 / "+pagesCount;
      ...
      for(var i = 1;i<pagesCount+1; i++)
      {
        ...
        if((i-1) %10 ==0){
          ...
          optionObj.innerHTML=i+"-"+(i+9)+"页";
          optionObj.data=i+"-"+(i+9);

            optionObj.addEventListener('click',function(){

                var pageParam  = this.data;

                j = 0;


                    var first = parseInt(pageParam.split('-')[0]);
                    var end = parseInt(pageParam.split('-')[1]);
                    for(var i = 1;i<pagesCount+1; i++) {
                        if(i>=first && i<=end)
                        {
                            var pageInfo = document.getElementById("pageInfo"+i);
            ...
            optionObj.style.fontSize="14px";
            pageInfo.appendChild(optionObj);
        }

          var optionObj=document.createElement("li");
          optionObj.innerHTML="第"+i+"页";
          optionObj.data=i;
          optionObj.id="pageInfo"+i;
            ...
            optionObj.addEventListener('click',function(){
                ...
                window.location.href = pageStr+pageParam;
          ...
          optionObj.addEventListener('mouseenter',function(){
              this.style.backgroundColor = "#828282";
          });
          optionObj.addEventListener('mouseout',function(){
      ...
      //   var selIndex = this.selectedIndex;     //获取当前选择的选项的index值
      //   var pageParam  = this.options[selIndex].value;
      //
      //   j = 0;
      ...
      //     window.location.href = pageStr+selValue;
      //   }
      //
      // });
...
function showPageInfo(){
    var display = document.getElementById("pageInfoContainer").style.display;
    if(display == "none")
    {
...
window.onload =function () {
    ...
    var pageSum = document.getElementById("pageSum");
    pageSum.addEventListener('mouseenter', function () {
        this.style.backgroundColor = "#828282";
    });
    pageSum.addEventListener('mouseout', function () {
