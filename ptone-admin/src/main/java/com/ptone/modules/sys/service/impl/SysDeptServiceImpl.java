...
import com.ptone.modules.sys.dao.SysDeptDao;
import com.ptone.modules.sys.dto.SysDeptDTO;
import com.ptone.modules.sys.entity.SysDeptEntity;
...
public class SysDeptServiceImpl extends BaseServiceImpl<SysDeptDao, SysDeptEntity> implements SysDeptService {
	...
	public Long selectIdByName(String deptName) {
		...
		List<SysDeptEntity> sysDeptEntities = baseDao.selectByMap(map);
		return sysDeptEntities.get(0).getId();
	}
